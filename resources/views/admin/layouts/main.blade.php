                    ...
                    <div class="md:flex">
                        ...
                        <div class="flex -mb-px mr-8">
                            <a href="{{ route('admin.invoicePage') }}"
                                class="no-underline text-primary opacity-50 md:text-grey-dark md:opacity-100 flex items-center py-4 hover:opacity-100 md:hover:border-grey-dark @if ($active == 'Invoice') border-b border-primary @endif">
                                <svg class="h-6 w-6 fill-current mr-2" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24">
                                    <path
