  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 pb-5.5 lg:pb-6.5">
        <Link
          href="/"
          className="flex gap-2 mt-10 w-full flex-col items-center justify-center"
        >
          <LogoFooter />
          <div className="flex flex-col gap-0 w-full items-center justify-center">
            <p className="font-bold text-4xl !font-delius text-white">SIMPAN</p>
            <p className="font-medium text-white text-sm text-center">
              Sistem Manajemen Pemesanan <br /> CV Fajar Teknika
            </p>
          </div>
        </Link>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {pathname.includes("operator") ? (
                <SidebarLinkGroup
                  activeCondition={
                    pathname === "/pemesanan" || pathname.includes("pemesanan")
                  }
                >
                  {(handleClick, open) => {
                    return (
                      ...
                      <React.Fragment>
                        ...
                        >
                          <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                            <li>
                              <Link
                                href="/admin/operator/barang"
                                className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                  pathname === "/admin/operator/barang" &&
                                  "text-white"
                                }`}
                              >
                                • Data Barang
